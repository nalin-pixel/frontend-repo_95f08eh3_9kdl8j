    ...
    <section className="relative pt-28 pb-20 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          {/* Left: Premium copy */}
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-100 text-purple-700 text-sm mb-6 ring-1 ring-purple-200/60">
          ...
          <div className="relative h-[420px] sm:h-[520px]">
            ...
            {/* Floating card */}
            <div className="absolute -bottom-6 -left-6 bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border border-white/60 p-5 w-72">
